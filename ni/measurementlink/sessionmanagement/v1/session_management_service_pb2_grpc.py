...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in ni/measurementlink/sessionmanagement/v1/session_management_service_pb2_grpc.py depends on'
...
def add_SessionManagementServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('ni.measurementlink.sessionmanagement.v1.SessionManagementService', rpc_method_handlers)
