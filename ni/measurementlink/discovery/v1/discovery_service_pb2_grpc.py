...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in ni/measurementlink/discovery/v1/discovery_service_pb2_grpc.py depends on'
...
class DiscoveryServiceServicer(object):
    ...
    def EnumerateServices(self, request, context):
        ...
        The response includes location information for services that are currently running, allowing
        callers to determine the port/address of a service without activating it via ResolveService.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_DiscoveryServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('ni.measurementlink.discovery.v1.DiscoveryService', rpc_method_handlers)
