...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in ni/measurementlink/pinmap/v1/pin_map_service_pb2_grpc.py depends on'
...
def add_PinMapServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('ni.measurementlink.pinmap.v1.PinMapService', rpc_method_handlers)
